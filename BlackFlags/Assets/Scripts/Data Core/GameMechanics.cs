...
namespace GameMechanics.Ships
{
    ...
    public abstract class Ship
    {
        ...
        protected static readonly Dictionary<string, Improvement> D_Improvements = new Dictionary<string, Improvement>()
        {
            ...
            {"Overblindsail", new Improvement(2, "Sobrecebadera", "Una verga montada en bauprés sobre la cebadera, que mejora la velocidad a barlovento, pero afecta al coste de mantenimiento y la visibilidad", new float[10]{ 0,0,.2f,.4f,-0.3f,1,0,15,0,0}, 4500) },
            {"Boatswainlocker", new Improvement(3, "Pañol de Contramaestre", "Redistribuyendo el espacio en el sollado se puede preparar un espacio del barco para herramientas y mantenimiento", new float[10]{ 0,0,0,0,0,0,0,-10,0,0},7000) },
            {"Staysail", new Improvement(4, "Estay de Mesana", "Un estay añade más superficie vélica al barco", new float[10]{ 0,.1f,.2f,.3f,0,1,0,10,0,5},3500) },
            {"Flyingjib", new Improvement(5, "Foque volante", "Un foque adicional añade más superficie de velamen", new float[10]{ 0,.1f,.2f,.3f,-0.1f,1,0,10,0,5},3500) },
            {"Foremaststay", new Improvement(6, "Estay de Trinquete", "Un estay añade más superficie vélica al barco", new float[10]{ 0,.1f,.2f,.3f,0,1,0,10,0,5},3000) },
        ...
        protected static readonly Dictionary<string, Improvement> D_Variants = new Dictionary<string, Improvement>()
        {
            ...
            {"Xebec", new Improvement(102, "Jabeque polacra", "Polacra con vela de jabeque en trinquete, muy utilizado por piratas del Mediterráneo", new float[10]{ 0.4f,0.4f,-0.4f,-0.6f,0,-2,13,-10,0,0},4100) },
            {"Barque", new Improvement(103, "Bribarca", "Barco de tres palos, similar a la fragata, con velas redondas en los dos primeros mástiles", new float[10]{ 0.5f,0.5f,-0.4f,-0.8f,0,-1,8,-10,0,0},4000) },
        };
