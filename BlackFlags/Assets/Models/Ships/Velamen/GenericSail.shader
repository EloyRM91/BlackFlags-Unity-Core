Shader "_BF Sails/Vela GENERICA Surf"
{
    Properties
    {
        //Textura
        ...
        _Seniode_Fr("Frecuencia senoidal", Range(-20, 20)) = 5
        _Seniode_Offset("Offset de la senoide",Range(-10, 10)) = 3
        ...
        SubShader
        {
            ...
            void vert(inout appdata_full data)
            {
                ...
                data.vertex.z = data.vertex.z + (_Seniode_Fr * _TimeOffset + _Seniode_Offset) * (data.vertex.x - (_Restriccion_OffsetY + _Restriccion_m * data.vertex.y)) * (data.vertex.x);
            }
