        ...
        private void SelectDifficulty(GameDifficulty level)
        {
            ...
            switch (level)
            {
                case GameDifficulty.easy:
                    ...
                    _Text_SelectedDifficulty.text += "F�cil";
                ...
                case GameDifficulty.hard:
                    //_TEXT_Gold.text += 450;
                    _Text_SelectedDifficulty.text += "Dif�cil";
            ...
            if (level != GameDifficulty.nightmare)
            {
                _Text_Modifiers.text =
                    ...
                    $"Moral de la tripulaci�n: {(PersistentGameData._GData_MoraleModifier >= 0 ? "+" : "")}{PersistentGameData._GData_MoraleModifier * 100}%";
            }
            else
            {
                _Text_Modifiers.text = "En modo \"Pesadilla\" la dificultad de comerciar, entablar amistades en el bajo mundo y satisfacer la vida a bordo ser� m�xima, y adem�s la moral a bordo no puede superar el 90% y las patrullas y corsarios siempre atacan.";
            }
